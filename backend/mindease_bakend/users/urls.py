...
urlpatterns = [
    ...
    path("verify-otp/", VerifyOtp.as_view(), name="otp"),
    path("resend-otp/", ResendOtp.as_view(), name="resend_otp"),
    path("get-profile/", ProfileView.as_view(), name="profile"),
    path("profile-image/", ProfileImageUpdateView.as_view(), name="update-profile-image"),
    path("verify-password/", VerifyPasswordView.as_view(), name="verify_password"),
    path("change-forgot-password/", ChangeForgotPasswordView.as_view(), name="change_password"),
