...
import { getTherapistNotifications, markAllTherapistNotifications, markTherapistNotificationAsRead } from '../../api/therapist';
 ...
 const [isOpen, setIsOpen] = useState(false);
  ...
  useEffect(() => {
    const fetchNotifications = async () => {
      const res = await getTherapistNotifications();
      if (res.success) {
  ...
  const handleMarkAsRead = async (id) => {
    const res = await markTherapistNotificationAsRead(id);
    if (res.success) {
  ...
  const markAllAsRead = async () => {
    const res = await markAllTherapistNotifications();
    if (res.success) {
      setNotifications(prev =>
