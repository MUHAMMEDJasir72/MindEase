...
function TherapistProfile({ therapist }) {
 ...
 useEffect(() => {
  const fetchData = async () => {
    ...
    if (data.success) {
      setTherapistData(data.data);  // set therapist data
      const rateData = await getTotalRating();  // use ID from profile
      if (rateData.success) {
        setRate(rateData.rate);  // set rating
      }
    }
  };

  fetchData();  // Only one function needed now
}, []);



  // Sample data - in your real app, this would come from props or API
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
              ...
              {/* Rating Section - Add this right after the basic info div */}
    ...
    <span className="ml-1 text-gray-600">
      {rate ? rate.toFixed(1) : 'No ratings yet'}
              ...
              <div className="w-full md:w-auto">
                <button onClick={() => setIsEditModalOpen(true)} className="w-full md:w-auto flex items-center justify-center px-4 py-2 border border-blue-600 text-blue-600 rounded-md hover:bg-blue-50 transition-colors">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div>
                ...
                <p className="text-gray-800">{therapistData.fullname}</p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-800">{therapistData.gender}</p>
              </div>
              ...
              <div>
                ...
                <div className="flex items-center">
                  ...
                  <p className="text-gray-800">{therapistData.phone}</p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex items-center">
                  ...
                  <p className="text-gray-800">{therapistData.state}, {therapistData.country}</p>
                </div>
              </div>
              ...
              <div className="md:col-span-2 lg:col-span-3">
                ...
                <div className="flex items-center">
                  <FaMapMarkerAlt className="text-gray-400 mr-2" />
                  <p className="text-gray-800">{therapistData.address}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-gray-800">{therapistData.professionalTitle}</p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-800">{therapistData.yearsOfExperience} years</p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-800">{therapistData.professionalLicenseNumber}</p>
              </div>
              
              <div>
                <label className="block text-sm font-medium text-gray-500 mb-1">Issuing Authority</label>
                <p className="text-gray-800">{therapistData.licenseIssuingAuthority}</p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              {therapistData.additionalCertificationDocument && (
                <a href={therapistData.additionalCertificationDocument} target="_blank" rel="noopener noreferrer" className="border rounded-lg p-4 hover:bg-gray-50 transition-colors">
                  <div className="flex flex-col items-center text-center">
                    <FaFileAlt className="text-gray-600 text-3xl mb-2" />
