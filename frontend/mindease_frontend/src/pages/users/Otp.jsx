                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        <div>
                            ...
                            <input
                                ...
                                pattern="\d{6}"
                                inputMode="numeric"
                                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent text-center text-xl tracking-widest"
                                placeholder="••••••"
                                required
                            />
                        </div>
                    ...
                    <div className="mt-6 text-center">
                        {canResend ? (
                            <button
                                ...
                                className="text-teal-600 hover:text-teal-500 font-medium focus:outline-none"
                            >
                                {isResending ? (
                                    <span className="flex items-center justify-center">
